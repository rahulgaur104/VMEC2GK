#!/usr/bin/env python3
"""
This script creates and saves a grid.out file for a GS2 run using local equilibrium data from a dictionary. There is also provision to change shat and dPdpsi locally. 

Usually called from eikcoefs_final_nperiod.py. It can be called from terminal too as long as there is a dictionary containing all the local equilibrium information.
